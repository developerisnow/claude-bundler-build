...
Use task tool sub-agents to orchestrate multiple task in parallel (prefer if possible) or sequence to accomplish my objectives. 

### Theory about sub-agents:
- @ai_docs/anthropic-publisher/sub-agents__anthropic.md
- @ai_docs/20250729-1400-anthropic-agent-system-analysis.md
